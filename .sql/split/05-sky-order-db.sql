-- ============================================================
-- 苍穹外卖 — 数据库拆分 5/5: sky_order_db（订单核心）
-- 表: orders, order_detail, undo_log (Seata AT)
-- 所属微服务: sky-order-service (:8086)
-- ============================================================

CREATE DATABASE IF NOT EXISTS `sky_order_db` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8_bin;
USE `sky_order_db`;
