-- ============================================================
-- 苍穹外卖 — 数据库拆分 3/5: sky_menu_db（菜单管理）
-- 表: category, dish, dish_flavor, setmeal, setmeal_dish
-- 所属微服务: sky-menu-service (:8084)
-- ============================================================

CREATE DATABASE IF NOT EXISTS `sky_menu_db` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8_bin;
USE `sky_menu_db`;
